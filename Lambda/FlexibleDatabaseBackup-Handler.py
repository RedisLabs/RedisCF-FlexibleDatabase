...
def lambda_handler (event, context):
    ...
    if event['RequestType'] == "Create":
        ...
        try:
            ...
            #     stateMachineArn = f'arn:aws:states:{runtime_region}:{aws_account_id}:stateMachine:FlexibleDatabaseBackup-StateMachine-{runtime_region}-{stack_name}',
            #     name = f'FlexibleDatabaseBackup-StateMachine-{runtime_region}-{stack_name}',
